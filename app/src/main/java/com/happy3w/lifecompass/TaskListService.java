...
public class TaskListService {
    ...
    public List<com.happy3w.lifecompass.api.generated.TaskDto> getTasks() {
        return taskRepository.findAll(DSL.noCondition()).stream().map(TaskListService::toApi).collect(Collectors.toList());
    }

    public long addTask(@UniqueTask com.happy3w.lifecompass.api.generated.TaskDto task) {
        return taskRepository.insert(fromApi(task));
    }

    public com.happy3w.lifecompass.api.generated.TaskDto getTask(long id) {
    ...
    public boolean updateTodo(long id, com.happy3w.lifecompass.api.generated.TaskDto task) {
    ...
    public void overwriteTasks(List<com.happy3w.lifecompass.api.generated.TaskDto> tasks)
            throws OptimisticLockingFailureException {
        Map<Long, Task> allTasks = taskRepository.findAllForUpdate(DSL.noCondition())
                .stream()
                .collect(Collectors.toMap(Task::getId, Function.identity()));
        for (com.happy3w.lifecompass.api.generated.TaskDto task : tasks) {
    ...
    private static Task fromApi(com.happy3w.lifecompass.api.generated.TaskDto task) {
        return Task.builder()
                .id(task.getId())
    ...
    private static com.happy3w.lifecompass.api.generated.TaskDto toApi(Task task) {
        return new com.happy3w.lifecompass.api.generated.TaskDto().id(task.getId())
                .version(task.getVersion())
                .title(task.getTitle())
